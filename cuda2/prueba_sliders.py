...
if __name__=='__main__':
    ...
    s.add_slider('permability', valinit=0.49, valinterval=[0,1], valstep=0.001)
    s.add_slider('lambda', valinit=0.210, valinterval=[0.16,0.28], valstep=0.001)
    s.add_slider('IFR', valinit=0.00085, valinterval=[0.0005,0.002], valstep=0.00001)
    s.add_slider('what', valinit=0.054, valinterval=[1/28,1/6], valstep=0.0001)
    s.add_slider('initial_i', valinit=2.5e-10, valinterval=[0, 0.8e-9], valstep=1e-11)
